...
namespace CityPointHire.Controllers
{
    ...
    public class EquipmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EquipmentID,EquipmentName,Availability")] Equipment equipment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EquipmentID,EquipmentName,Availability")] Equipment equipment)
        {
